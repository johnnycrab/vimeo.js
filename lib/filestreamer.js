...
FileStreamer.prototype._putFile = function (start, callback) {
    ...
    file.on('open', function (fd) {
        console.log('Got read stream file descriptor');
...
FileStreamer.prototype._closeReadStreamFd = function () {
    if (this._readStreamFd) {
        console.log('cleaning up read stream file descriptor');
        fs_module.close(this._readStreamFd);
